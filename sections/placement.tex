...
constraints.  The subsequent routers were placed approximately $\frac{1}{3}$
around the X- and Z-dimensions.  Between sections, the starting X- and
Z-dimensions are offset.  The final placement map is shown in
Figure~\ref{fig:titanlayout}.
