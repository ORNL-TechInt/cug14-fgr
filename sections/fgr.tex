...
\label{first:begin}
    ...
    \If{ ($C[y] == R^G_{i}(S)[y]-1$) 
    \\ \hspace{\algorithmicindent} \hspace{\algorithmicindent}   or ($C[y] == R^G_{i}(S)[y]$)
    \\ \hspace{\algorithmicindent} \hspace{\algorithmicindent}   or ($C[y] == R^G_{i}(S)[y] + 1$) 
    \\ \hspace{\algorithmicindent} \hspace{\algorithmicindent}   or ($C[y] == R^G_{i}(S)[y] + 2$)}
